        ...
        <div className="login">
            <div className="container d-flex align-items-center justify-content-center py-4">
                <div className="form-container p-4">
                    <p className="title text-center fs-2 fw-bold">Log In</p>
                    <form className="form">
                        ...
                        <div className="input-group">
                            ...
                            <div className="forget my-2">
                                <a rel="noopener noreferrer" href="#">Forget Password ?</a>
                            </div>
                        </div>
                        <div className="terms d-flex align-items-center gap-2 mb-2 ">
                            <input type="checkbox"/>
                            <label className="fw-bold" >I agree to the <a href="/terms">Terms and Conditions</a></label>
                        </div>
                        <button className="sign w-100 py-1 fw-bold">Log in</button>
                    </form>
                    <div className="social-message d-flex align-items-center pt-1">
                        <div className="line"></div>
                        <p className="message pt-2 px-2">Login with social accounts</p>
                        <div className="line"></div>
                    </div>
                    ...
                    <p className="signup text-center">Create new account 
                        <a rel="noopener noreferrer" href="/sign_up" className=" ms-1">Sign up</a>
                    </p>
                </div>
            </div>
        </div>
